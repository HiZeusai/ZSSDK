...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "ZSSDK",
            url: "https://github.com/HiZeusai/SDKPackage/releases/download/2.1.12/ZSSDK_2.1.11_20260125110942.zip",
            checksum: "94e963859818c8345a2584f075ccf3386987596540e0c1757d288018b2b7248a"
        ),
        .binaryTarget(
            name: "ZSCoreKit",
            url: "https://github.com/HiZeusai/SDKPackage/releases/download/2.1.12/ZSCoreKit_2.1.11_20260125110942.zip",
            checksum: "a88b840cd604b79b365174c98da25efc76c2d72c0bc4300f9f49235f7c6a8c0f"
        ),
        .binaryTarget(
            name: "YKIAPStoreKit",
            url: "https://github.com/HiZeusai/SDKPackage/releases/download/2.1.12/YKIAPStoreKit.xcframework.zip",
            checksum: "f4cbebade4061551c574c990dbe462bfc9118bf3ee3df92bbcd7dc3222dbc91a"
        ),
        .binaryTarget(
            name: "Pay_zeus",
            url: "https://github.com/HiZeusai/SDKPackage/releases/download/2.1.12/Pay_zeus_2.1.11_20260125110942.zip",
            checksum: "cc27911e64dc041b6c0736ca9f80faa16fb3c8238924dab4c539194d4b5745ef"
        ),
        .binaryTarget(
            name: "Analytics_Adjust",
            url: "https://github.com/HiZeusai/SDKPackage/releases/download/2.1.12/Analytics_Adjust_2.1.11_20260125111829.zip",
